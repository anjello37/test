@scenarios @MagistratiEUnita
Feature: MagistratiEUnita
...
Scenario: Navigate to Ricerche > Progetto Organizzativo > Magistrati e Unità  
	When I expand Ricerche from ORGANIZZAZIONE DEGLI UFFICI
	And I expand Progetto Organizzativo from Ricerche
	And I click to Magistrati e Unità
	Then I should be able to navigate to Magistrati e Unità